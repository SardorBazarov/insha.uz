  ...
  const submitHandler = (e) => {
    ...
    if (!newLat || !newLng) {
      moveOn = window.confirm(
        'Siz GeoLokatsiyangizni xaritadan topmadingiz. Davom ettirasizmi?'
      );
    }
    if (moveOn) {
      dispatch(
  ...
  return (
    <div>
      ...
      <form className="form" onSubmit={submitHandler}>
        ...
        <div>
          <label htmlFor="postalCode">Pochta ZIP raqami</label>
          <input
            type="text"
            id="postalCode"
            placeholder="Hududiy Pochta raqamingizni kiriting"
            value={postalCode}
        ...
        <div>
          <label htmlFor="chooseOnMap">GeoLokatsiya</label>
...
rt { saveShippingAddress } from '../actions/cartActions';
import CheckoutSteps from '../components/CheckoutSteps';
